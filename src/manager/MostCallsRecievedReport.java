 ...
 */
public class MostCallsRecievedReport implements JasperVierwerToSwing{
    ...
    public List <Map<String,?>> generateDataSource() {
        ...
        for(Cdr cdr: cdrManager.MostCallsRecievedQuery())
        {
    ...
    public String getSource() {
        return "src/hibernateReports/MasRecibidas.jrxml";
    }
